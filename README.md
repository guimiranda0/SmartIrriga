...
O sistema realiza a leitura da umidade do solo por meio de um sensor conectado ao Arduino Uno. Quando a umidade fica abaixo do valor definido, o Arduino aciona o módulo relé, responsável por ativar a bomba de água.
